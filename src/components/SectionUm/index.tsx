export const SectionUm = () => {
  return (
    <div className="gradient-branco px-3 py-10 flex flex-col items-center gap-10 shadow-2xl md:px-20 md:py-10 lg:flex-row lg:justify-between xl:px-30 xl:py-20  2xl:px-52">
      <h1 className=" text-black text-center text-4xl  font-bold md:text-center lg:text-left xl:text-5xl   2xl:text-7xl 2xl:w-[70%] ">
      ...
      <div className="shadow-2xl rounded-3xl">
        <iframe
          className="rounded-3xl shadow-2xl w-[380px] h-[200px]  xl:w-[560px] xl:h-[315px] 2xl:w-[760px] 2xl:h-[415px]"
